...
public class PrintUtils {
    ...
    public static String displayBoard(GameData gameData, ChessGame.TeamColor color) {
        return showMoves(gameData, color, null);
    }

    public static String showMoves(GameData gameData, ChessGame.TeamColor color, Collection<ChessMove> moves) {
